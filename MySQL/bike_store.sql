...
-- -----------------------------------------------------
-- Table `bike_store`.`product_categories`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bike_store`.`product_categories` ;

CREATE TABLE IF NOT EXISTS `bike_store`.`product_categories` (
  `product_id` INT NOT NULL,
